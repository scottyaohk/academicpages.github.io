...
- **Results**
    ...
    - <div style="display: flex; justify-content: space-between;">
        <img src=info-another-perspective/3.png width=45% />
        <img src=info-another-perspective/3s.png width=45% />
        </div>
        <br />
    - <div style="display: flex; justify-content: space-between;">
        <img src=info-another-perspective/6.png width=45% />
        <img src=info-another-perspective/6s.png width=45% />
        </div>
        <br />
    - <div style="display: flex; justify-content: space-between;">
        <img src=info-another-perspective/9.png width=45% />
        <img src=info-another-perspective/9s.png width=45% />
        </div>
- **Findings**
...
<div style="display: flex; justify-content: space-between;">
<img src=info-another-perspective/elephants.jpg width=100% style="margin: 20px"/>
<img src=info-another-perspective/koala_from_elephant.jpg width=100% style="margin: 20px"/>
</div>
<div style="display: flex; justify-content: space-between;">
...
<br />
<div style="display: flex; justify-content: space-between;">
<img src=info-another-perspective/koala_from_elephant_minus.jpg width=100% style="margin: 20px"/>
<img src=info-another-perspective/koala_from_elephant_minus_10times.jpg width=100% style="margin: 20px"/>
</div>
<div style="display: flex; justify-content: space-between;">
