...
- **Results**
    ...
    - ![](info-another-perspective/posts/3.png){: .align-left } ![](info-another-perspective/posts/3s.pn){: .align-left }
    - <img src=info-another-perspective/posts/3.png width=45% /><img src=info-another-perspective/posts/3s.png width=45% />
    - <div style="display: flex; justify-content: space-between;">
        <img src=info-another-perspective/posts/6.png width=45% />
        <img src=info-another-perspective/posts/6s.png width=45% />
        </div>
        <br />
    - <div style="display: flex; justify-content: space-between;">
